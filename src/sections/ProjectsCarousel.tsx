...
function ProjectRow({ project, index }: { project: Project; index: number }) {
  ...
  return (
    <div className="border-t border-subtle py-16 md:py-20">
      ...
      {/* title */}
      <Reveal delay={0.05}>
        <h3 className="text-4xl md:text-6xl lg:text-7xl font-display font-extrabold tracking-tight leading-[1.0] mb-4 text-balance">
          {project.title}
        </h3>
      </Reveal>
    ...
    <section id="projects" className="relative py-24 md:py-32">
      <div className="container-pad max-w-7xl mx-auto">
        ...
        <Reveal>
          ...
          <h2 className="text-display-md font-display font-extrabold tracking-tight mb-20 md:mb-28">projects</h2>
        </Reveal>
